...
| # | Sub-topic | Status |
|---|-----------|--------|
| 15.1 | [Hadoop](#151-hadoop) | Documented |
| 15.2 | [Spark](#152-spark) | Documented |
| 15.3 | [Flink](#153-flink) | Documented |
| 15.4 | [ETL](#154-etl) | Documented |
| 15.5 | [ELT](#155-elt) | Documented |
| 15.6 | [Batch Processing](#156-batch-processing) | Documented |
| 15.7 | [Stream Processing](#157-stream-processing) | Documented |
| 15.8 | [Data Lake](#158-data-lake) | Documented |
| 15.9 | [Data Warehouse](#159-data-warehouse) | Documented |
| 15.10 | [Lakehouse Architecture](#1510-lakehouse-architecture) | Documented |
...
| Pattern | Latency | Best for | Typical stack |
|---------|---------|----------|---------------|
| Batch | Hours | Reports, ML training | Spark on S3, Airflow |
| Stream | Seconds | Fraud, live metrics | Kafka + Flink |
| ETL | Varies | Governed warehouse load | Informatica, Spark |
| ELT | Varies | Cloud warehouse | Fivetran + dbt + Snowflake |
| Data lake | Query-dependent | Raw retention, ML | S3 + Parquet + Spark |
| Data warehouse | Seconds–minutes | BI, SQL analytics | Snowflake, BigQuery |
| Lakehouse | Seconds–minutes | Unified platform | Delta/Iceberg + Databricks |
