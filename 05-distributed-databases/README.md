...
| 5.16 | [Distributed Transactions](../08-microservices/README.md#89-distributed-transactions) |
...
- **Cross-shard transactions** — avoid designing workflows that need ACID across shards; use [sagas](../08-microservices/README.md#89-distributed-transactions) or per-shard consistency.
...
> **Canonical coverage:** [8.9 Distributed Transactions](../08-microservices/README.md#89-distributed-transactions) — two-phase commit, three-phase commit, saga pattern, and transaction outbox for microservices.
