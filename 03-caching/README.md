...
Production systems often use **DB first, then cache update** with retry, or a [transaction outbox](../08-microservices/README.md#87-distributed-transactions) if both must be atomic across nodes.
