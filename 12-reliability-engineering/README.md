...
| # | Sub-topic | Status |
|---|-----------|--------|
| 12.1 | [Chaos Engineering](#121-chaos-engineering) | Done |
| 12.2 | [Disaster Recovery](#122-disaster-recovery) | Done |
| 12.3 | [Backup Strategy](#123-backup-strategy) | Done |
| 12.4 | [Restore Strategy](#124-restore-strategy) | Done |
| 12.5 | [RPO](#125-rpo) | Done |
| 12.6 | [RTO](#126-rto) | Done |
| 12.7 | [High Availability](#127-high-availability) | Done |
| 12.8 | [Active Active](#128-active-active) | Done |
| 12.9 | [Active Passive](#129-active-passive) | Done |
...
| Concept | Measures | Typical values |
|---------|----------|----------------|
| RPO | Max data loss | 0 (sync) to 24h (daily backup) |
| RTO | Max downtime | 5 min (hot) to 24h (cold) |
| Active-Active | Both sites live | Lowest RTO, highest complexity |
| Active-Passive | Standby on fail | Minutes RTO, moderate cost |
| Chaos | Proactive failure test | Start with pod kill |
| Backup 3-2-1 | Copy diversity | 3 copies, 2 media, 1 offsite |
